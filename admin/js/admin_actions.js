$(document).ready(function(){
    ...
    var URL = origin+'/'+path[1]+'/'+path[2]+'/'+path[3]+'/'+path[4]+'/';
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        ...
                        setTimeout(function(){ window.location = 'http://localhost/files/myallproject/php/shopping-project/admin/dashboard.php'; }, 1000);
